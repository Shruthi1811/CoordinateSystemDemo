...
//
//  Created by Battu,Shruthi on 3/1/22.
//
...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        print("(\(midX), \(midY))");
        //change the location of the tiger to the upper left corner
        imageViewOutlet.frame.origin.x = 0
        imageViewOutlet.frame.origin.y = 0
        
        //change the location of the tiger to the upper right corner
        imageViewOutlet.frame.origin.x = 314
        imageViewOutlet.frame.origin.y = 0
        
        //change the location of the tiger to bottom left corner
        imageViewOutlet.frame.origin.x = 0
        imageViewOutlet.frame.origin.y = 796
        
        //change the location of the tiger to the bottom right corner
        imageViewOutlet.frame.origin.x = 314
        imageViewOutlet.frame.origin.y = 796
        
        //change the location of the object to the center of the screen
